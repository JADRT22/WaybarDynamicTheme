...
# =============================================================================
# WAYBAR DYNAMIC THEME - INSTALLATION SCRIPT
...
# Copying templates to the correct directory
templates=(
...
# --- 4. LINK SCRIPTS ---
echo -e "
${YELLOW}[4/4] Linking scripts to Hyprland...${NC}"
scripts=("WaybarDynamicHub.sh" "DynamicLayoutSwitcher.sh" "Refresh.sh")
...
echo -e "2. Add a keybind in your Hyprland config:"
echo -e "   ${YELLOW}bind = \$mainMod, G, exec, $HYPR_SCRIPTS_DIR/WaybarDynamicHub.sh${NC}"
